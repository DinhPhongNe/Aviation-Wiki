let dataAPIAirline = {
    "rows": [
      ...
      {
        "Name": "Australia - Royal Australian Air Force",
        "Code": "",
        "ICAO": "ASY"
      },
      {
      ...
      {
        "Name": "Avincis Aviation Portugal",
        "Code": "",
        "ICAO": "BBO"
      },
      {
        "Name": "Avincis Aviation Sweden",
        "Code": "",
        "ICAO": "DFL"
      },
      {
      ...
      {
        "Name": "Hong Kong - Government Flying Service",
        "Code": "",
        "ICAO": "GFS"
      },
      {
      ...
      {
        "Name": "Netherlands - Royal Air Force",
        "Code": "",
        "ICAO": "NAF"
      },
      {
      ...
      {
        "Name": "Russia - 224th Flight Unit State Airline",
        "Code": "",
        "ICAO": "TTF"
      },
      {
      ...
      {
        "Name": "Tyrolean Jets & Services Malta",
        "Code": "",
        "ICAO": "TYJ"
      },
      {
      ...
      {
        "Name": "United Kingdom - UK Royal/VIP Flights",
        "Code": "",
        "ICAO": "KRF"
      },
      {
      ...
      {
        "Name": "United States - US Marshals Service",
        "Code": "",
        "ICAO": "MSH"
      },
      {
  ...
  function DisplaydataAPIAirline(data) {
    for (let i = 0; i < data.rows.length; i++) {
      let li = document.createElement("li");
      let divTrendCard = document.createElement("div");
      divTrendCard.classList.add("trend-card");
  
      let divCardTitleWrapper = document.createElement("div");
      divCardTitleWrapper.classList.add("card-title-wrapper");
  
      let a = document.createElement("a");
      a.href = "#";
      a.classList.add("card-title");
      a.innerHTML = "Code: " + `<span class='span'>${data.rows[i].Code}</span>`;
      divCardTitleWrapper.appendChild(a);
      divTrendCard.appendChild(divCardTitleWrapper);
  
      let span = document.createElement("span");
      span.classList.add("card-value");
      span.innerText = data.rows[i].Name; // Models > name
      divTrendCard.appendChild(span);
  
      let divCardAnalytics = document.createElement("div");
      divCardAnalytics.classList.add("card-analytics");
  
      let span2 = document.createElement("span");
      span2.classList.add("current-price");
      span2.innerText = "ICAO Code: " + data.rows[i].ICAO; // Models > Code
  
      divCardAnalytics.appendChild(span2);
      divTrendCard.appendChild(divCardAnalytics);
  
      li.appendChild(divTrendCard);
  
      document.getElementById("tab-content").appendChild(li);
    }
  }
  
  // Call the function with the example data
  DisplaydataAPIAirline(dataAPIAirline);