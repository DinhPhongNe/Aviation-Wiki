class AboutSection {
    constructor() {
      ...
      bannerImage.src = "./assets/images/about/about-banner_4.png";
      ...
      this.title.textContent = "Airlines?";
      ...
      const item1 = new SectionListItem("Find your fav airline!", "Lorem ipsum dolor sit amet consectetur adipisicing elit. Facilis illum optio eligendi a porro ipsum maxime veniam consectetur, obcaecati sequi cumque harum nostrum animi quod beatae praesentium ratione doloribus deserunt.");
