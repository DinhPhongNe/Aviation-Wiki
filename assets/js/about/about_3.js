class AboutSection {
    constructor() {
      ...
      bannerImage.src = "./assets/images/about/about-banner_3.png";
      ...
      this.title.textContent = "Find airport";
      ...
      const item1 = new SectionListItem("find your city's airport", "Lorem ipsum dolor sit amet consectetur adipisicing elit. Facilis illum optio eligendi a porro ipsum maxime veniam consectetur, obcaecati sequi cumque harum nostrum animi quod beatae praesentium ratione doloribus deserunt.");
      const item2 = new SectionListItem("explore!", "Lorem ipsum, dolor sit amet consectetur adipisicing elit. Nostrum, distinctio? Tempora omnis cum ut voluptatibus perspiciatis, amet soluta corrupti alias distinctio iste fuga dolorum aperiam, inventore sunt id consequatur illum.");
